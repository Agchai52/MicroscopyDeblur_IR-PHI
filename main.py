...
parser.add_argument('--L2_lambda', dest='L2_lambda', type=float, default=0.0001, help='weight on L2 term in objective')
parser.add_argument('--LR_lambda', dest='LR_lambda', type=float, default=0.0001, help='weight on LR term in objective')
