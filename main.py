...
parser.add_argument('--classes', dest='classes', type=int, default=32, help='rescale image to this size')
...
parser.add_argument('--L1_lambda', dest='L1_lambda', type=float, default=1., help='weight on LR term in objective')
